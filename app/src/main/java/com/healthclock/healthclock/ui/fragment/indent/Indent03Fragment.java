...
public class Indent03Fragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    private void initData(int pageNum, final boolean isloadmore) {
        ...
        RetrofitUtil.getInstance().GetOrderList(token, "3", String.valueOf(pageNum), new Subscriber<BaseResponse<OrderListModel>>() {
            @Override
