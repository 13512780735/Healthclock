 ...
 *
 */
package com.healthclock.healthclock.clock.broadcast;
...
public class AlarmClockBroadcast extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        L.e("执行了4444！！！！");
        String json = intent.getExtras().getString(WeacConstants.ALARM_CLOCK);
//        Type type = new TypeToken<AlarmClock>() {
//        }.getType();

        AlarmClock alarmClock = new Gson().fromJson(json, AlarmClock.class);
        L.e("执行了4444！！！！" + alarmClock.getRingName());
        if (alarmClock != null) {
            // 单次响铃
