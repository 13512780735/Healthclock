...
public class RetrofitUtil {
    ...
    public void getUserLogin(String username, String password, String openid, Subscriber<BaseResponse<LoginRegisterBean>> subscriber) {
     ...
     * @param subscriber
     */
    public void getUserRegister(String username, String code, String password, String referralCode, Subscriber<BaseResponse<LoginRegisterBean>> subscriber) {
     ...
     * @param subscriber
     */
    public void getUserForgetPwd(String username, String code, String newpassword, Subscriber<BaseResponse<EmptyEntity>> subscriber) {
